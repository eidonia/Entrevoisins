...
public class MyNeighbourFacRecyclerViewAdapter extends RecyclerView.Adapter<MyNeighbourFacRecyclerViewAdapter.ViewHolder> {

    private final List<Neighbour> mNeighbours;
    private NeighbourApiService mApiService;

    public MyNeighbourFacRecyclerViewAdapter(List<Neighbour> items) {
        mNeighbours = items;
    }
